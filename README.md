...
3. To add a new key press the lock icon in the browser toolbar and enter/generate your new key and description. To toggle which key is active simply click on the key (shift-click for multiple keys). Note that you may have to refresh the page to see some decryptions adding a new key.
4. Encrypt stuff!
